 ...
 */
class Guidance_VendorBridge_Block_Adminhtml_Export_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     *
     */
    ...
    {
        /** @var $collection Guidance_VendorBridge_Model_Resource_Export_Collection */
        $collection = Mage::getModel('vendorbridge/export')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('type', array(
            'header' => Mage::helper('vendorbridge')->__('Export Type'),
            'align'  => 'left',
            'width'  => '50px',
            'index'  => 'type',
        ));
    ...
    /**
     * @return Guidance_VendorBridge_Block_Adminhtml_Export_Grid|Mage_Adminhtml_Block_Widget_Grid
     */
    protected function _prepareMassaction()
    {
        $this->setMassactionIdField('id');
        $this->getMassactionBlock()->setData('form_field_name', 'export');

        $this->getMassactionBlock()->addItem('delete', array(
            'label'   => Mage::helper('vendorbridge')->__('Delete export record(s)'),
            'url'     => $this->getUrl('*/*/massDelete'),
            'confirm' => Mage::helper('vendorbridge')->__('Really delete the selected export record(s)?')
        ));
